 ...
 */
class Comment extends \Blog\Model\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('content' => NULL, 'post' => NULL);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'content', 'post', 'inputFilter', 'creationDate', 'user');
        }

        return array('__isInitialized__', 'id', 'inputFilter', 'creationDate', 'user');
    }
